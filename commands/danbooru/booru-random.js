...
const { Prefix, CommandsHyperlink, DanbooruLogin, DanooruApiKey } = require('../../settings.json')
...
module.exports = {
    ...
    cooldown: 5,
    details: `[booru.random](${CommandsHyperlink} 'Get a random image post from danbooru by tags. [Develper only]')`,
