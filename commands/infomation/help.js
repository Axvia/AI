...
module.exports = {
    ...
    aliases: ["help"],
    cooldown: 5,
    details: `[help](${CommandsHyperlink} 'Help menu')`,
    permissions: [ ],
    status: "Active",
    launch: async(client, message, args) => {
        try {
                    ...
                    for (const data of commands) {
                        ...
                        for (const key of CommandKey) {
                            if (key.category == "Information") {
                                cmdInformation.push(key.details) // key.details
                            }
                            if (key.category == "Danbooru") {
                                cmdDanbooru.push(key.details) // key.details
                            }
                            if (key.category == "Images") {
                                cmdImages.push(key.details) // key.details
                            }
                            if (key.category == "Search") {
                                cmdSearch.push(key.details) // key.details
                            }
                            if (key.category == "Utilities") {
                                cmdUtilities.push(key.details) // key.details
                            }
                            if (key.category == "Server") {
                                cmdServer.push(key.details) // key.details
                            }
                            if (key.category == "Fun") {
                                cmdFun.push(key.details) // key.details
                            }
                            if (key.category == "Analyze") {
                                cmdAnalyze.push(key.details) // key.details
                            }
                        }
                    }
                })
            ...
            await message.channel.send("Sorry, I'm unable to send my help menu. An error occurred.")
