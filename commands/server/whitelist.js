...
const { whitelist } = require('../../modules/schema')
...
module.exports = {
    ...
    aliases: ['whitelist'],
    cooldown: 10,
    details: `[whitelist](${CommandsHyperlink} 'Enable/Disable channel whitelisting. Only whitelisted channels can use commands.')`,
