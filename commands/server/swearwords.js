...
const { swearWords } = require('../../modules/schema')

module.exports = {
    name: `swearword`,
    desc: `Delete swear words by creating swear words collection`,
    usage: `\`${Prefix}swearword <create | swear | collection | delete>\``,
    category: `Server`,
    accessibly: `Administrator`,
    aliases: ["swearword", "swearw"],
    cooldown: 5,
    details: `[swearword](${CommandsHyperlink} 'Delete swear words by creating swear words collection')`,
    ...
    launch: async(client, message, args) => {
        try {
            ...
            if (options === "create") {
                ...
                const embed = new Discord.MessageEmbed()
                .setColor("GOLD").setTitle("Swear Words - Info").setTimestamp()
                .addField("⚒️ | Commands", 
